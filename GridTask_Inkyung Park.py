...
###############################
#Read before running the task!!!
#Please change the directory assigned to 'dir' on line 30 to match the folder containing the script file, trialSeq.py and log file.csv.
###############################
...
#######Set the logfile.csv directory 
#Change dir to match your current directory
dir = 'C:/Users/pikpi/OneDrive - University of Iowa/00_Courses/0_Programming/course project/PSY-5070-course-project-master'
fuldir = dir + '/logfile.csv'
...
log_file = open(fuldir, 'a') #open log file



#######Open experiment setup prompt 
expName = 'DriftD Study 01'  
expPrompt = {'RP': 'Dummy_05', 'RA initial': '9999', 'session': '9999', 'cond': '9999'} #Research Participant ID, Research Assitant initial, session # and condition
