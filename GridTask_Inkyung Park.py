...
dir = 'C:/Users/pikpi/OneDrive - University of Iowa/Social Cognition Lab/WT DDM/Task 01'
...
win = visual.Window(
    size = (1600,900),fullscr=False, screen=2, 
...
expPrompt = {'RP': '', 'RA initial': '', 'session': '', 'cond': ''} #Research Participant ID, Research Assitant initial, session # and condition
dlg = gui.DlgFromDict(dictionary=expPrompt, sortKeys=False, title=expName)  #pop open a dialogue box aksing expPrompt 

#quit if the user pressed cancel in the dialogue box
if dlg.OK == False:
    core.quit()  
